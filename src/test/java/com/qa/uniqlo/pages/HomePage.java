...
public class HomePage {
    ...
    public String getHomePageTitle() throws Exception {
        String homePageTitle = commonHandler.getTitle();
        Log.info("PAGE TITLE= " + homePageTitle);
        return homePageTitle;
    }

    public String getHomePageUrl() throws Exception{
        String homePageUrl = commonHandler.getUrl();
        Log.info("PAGE URL= " + homePageUrl);
        return homePageUrl;
    }

    public void verifyHomePageTitle(@NotNull String actTitle, @NotNull String expTitle) {
        commonHandler.verifyIfStringIsEqual(actTitle, expTitle);
    }

    public void verifyHomePageUrl(@NotNull String actUrl, @NotNull String expUrl) {
        commonHandler.verifyIfStringIsEqual(actUrl, expUrl);
    }
